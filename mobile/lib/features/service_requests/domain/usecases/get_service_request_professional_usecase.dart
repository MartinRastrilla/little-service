...
class GetServiceRequestProfessionalUseCase
    implements UseCase<ServiceRequestProfessional, String> {
  final ServiceRequestsRepository repository;

  const GetServiceRequestProfessionalUseCase(this.repository);

  @override
  Future<Either<Failure, ServiceRequestProfessional>> call(
    String serviceRequestId,
  ) {
    return repository.getServiceRequestProfessional(serviceRequestId);
  }
}
