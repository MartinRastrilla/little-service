...
mixin _$AuthResponseModel {
 ...
 String get token;@JsonKey(fromJson: dateTimeFromJson, toJson: dateTimeToJson) DateTime get expiresAt; UserModel get user;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AuthResponseModel&&(identical(other.token, token) || other.token == token)&&(identical(other.expiresAt, expiresAt) || other.expiresAt == expiresAt)&&(identical(other.user, user) || other.user == user));
}
...
@override
String toString() {
  return 'AuthResponseModel(token: $token, expiresAt: $expiresAt, user: $user)';
}
...
@useResult
$Res call({
 String token,@JsonKey(fromJson: dateTimeFromJson, toJson: dateTimeToJson) DateTime expiresAt, UserModel user
});
...
/// Create a copy of AuthResponseModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? token = null,Object? expiresAt = null,Object? user = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String token, @JsonKey(fromJson: dateTimeFromJson, toJson: dateTimeToJson)  DateTime expiresAt,  UserModel user)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthResponseModel() when $default != null:
return $default(_that.token,_that.expiresAt,_that.user);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String token, @JsonKey(fromJson: dateTimeFromJson, toJson: dateTimeToJson)  DateTime expiresAt,  UserModel user)  $default,) {final _that = this;
switch (_that) {
case _AuthResponseModel():
return $default(_that.token,_that.expiresAt,_that.user);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String token, @JsonKey(fromJson: dateTimeFromJson, toJson: dateTimeToJson)  DateTime expiresAt,  UserModel user)?  $default,) {final _that = this;
switch (_that) {
case _AuthResponseModel() when $default != null:
return $default(_that.token,_that.expiresAt,_that.user);case _:
  return null;
...
class _AuthResponseModel extends AuthResponseModel {
  const _AuthResponseModel({required this.token, @JsonKey(fromJson: dateTimeFromJson, toJson: dateTimeToJson) required this.expiresAt, required this.user}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AuthResponseModel&&(identical(other.token, token) || other.token == token)&&(identical(other.expiresAt, expiresAt) || other.expiresAt == expiresAt)&&(identical(other.user, user) || other.user == user));
}
...
/// Create a copy of AuthResponseModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? token = null,Object? expiresAt = null,Object? user = null,}) {
